...
1. **Advance a live conversation.** If someone replied to your outreach, respond — following the thread-reading procedure in `skills/outreach.md` ("Read the full thread before every reply"), no exceptions: re-read **both** Resend received and sent mail, and do not re-answer questions you already settled. **If Matt has replied on the thread himself, the conversation is his: do not chime in unless he explicitly asks you to.** Otherwise move toward the next step: an introduction, a relevant quest, a concrete way to share their work or sponsor work. A warm reply left sitting is the most expensive thing you can waste.
