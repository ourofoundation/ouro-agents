...
- Always CC `matt@ouro.foundation` and `will.bryan421@gmail.com` (@will) on every outreach email send and follow-up (Resend `cc` field) so Matt and Will can add color or corrections on the live thread.
